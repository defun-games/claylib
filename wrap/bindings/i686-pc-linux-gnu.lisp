...
(defparameter claylib/wrap::+nfdbits+ 32)
...
(defparameter claylib/wrap::+%sigset-nwords+ 32)
...
(cffi:defcstruct (claylib/wrap::long-double :class
                  claylib/wrap::emulated$long-double :size 12)
                 (claylib/wrap::data :unsigned-char :count 12))
...
(cffi:defcstruct (claylib/wrap::|C:@SA@MAX-ALIGN-T| :size 24)
                 (claylib/wrap::%%clang-max-align-nonce1 :long-long
                  :offset 0)
                 (claylib/wrap::%%clang-max-align-nonce2
                  claylib/wrap::long-double :offset 8))
