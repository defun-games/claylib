...
(defparameter claylib/wrap::+%wchar-t-defined+ 1)
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-PROPERTY-ELEMENT| :int)
...
(cffi:defcstruct (claylib/wrap::%io-file :size 208))
...
(cffi:defcstruct (claylib/wrap::%io-file :size 208)
                 ...
                 (claylib/wrap::%cur-column :unsigned-short :offset
                  124)
                 (claylib/wrap::%vtable-offset :char :offset 126)
                 (claylib/wrap::%shortbuf :char :count 1 :offset 127)
                 ...
                 (claylib/wrap::%freeres-buf (:pointer :void) :offset
                  168)
                 (claylib/wrap::%mode :int :offset 184)
                 (claylib/wrap::%unused2 :char :count 20 :offset 188))
...
(cffi:defcunion (claylib/wrap::|C:@SA@--MBSTATE-T@U@--MBSTATE-T.H@451|
                 :size 4)
                (claylib/wrap::%%wch :unsigned-short)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'claylib/wrap::+%wchar-t-defined+ :claylib/wrap)
