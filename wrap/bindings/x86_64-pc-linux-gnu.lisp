;; Generated by :claw at 2023-03-14T15:04:44.123346Z
...
(defparameter claylib/wrap::+big-endian+ 4321)
...
(defparameter claylib/wrap::+little-endian+ 1234)

(defparameter claylib/wrap::+l-ctermid+ 9)
...
(defparameter claylib/wrap::+nfdbits+ 64)

(defparameter claylib/wrap::+null+ 0)

(defparameter claylib/wrap::+pdp-endian+ 3412)

(defparameter claylib/wrap::+pi+ 3.1415927410125732D0)

(defparameter claylib/wrap::+p-tmpdir+ "/tmp")
...
(defparameter claylib/wrap::+raygui-textinputbox-button-height+ 28)

(defparameter claylib/wrap::+raygui-textinputbox-button-padding+ 12)

(defparameter claylib/wrap::+raygui-textinputbox-height+ 28)
...
(defparameter claylib/wrap::+rtld-binding-mask+ 3)

(defparameter claylib/wrap::+rtld-deepbind+ 8)

(defparameter claylib/wrap::+rtld-default+ nil)

(defparameter claylib/wrap::+rtld-global+ 256)

(defparameter claylib/wrap::+rtld-lazy+ 1)

(defparameter claylib/wrap::+rtld-local+ 0)

(defparameter claylib/wrap::+rtld-next+ nil)

(defparameter claylib/wrap::+rtld-nodelete+ 4096)

(defparameter claylib/wrap::+rtld-noload+ 4)

(defparameter claylib/wrap::+rtld-now+ 2)
...
(defparameter claylib/wrap::+wcontinued+ 8)

(defparameter claylib/wrap::+wexited+ 4)

(defparameter claylib/wrap::+wnohang+ 1)

(defparameter claylib/wrap::+wnowait+ 16777216)

(defparameter claylib/wrap::+wstopped+ 2)

(defparameter claylib/wrap::+wuntraced+ 2)

(defparameter claylib/wrap::+%alloca-h+ 1)

(defparameter claylib/wrap::+%atfile-source+ 1)

(defparameter claylib/wrap::+%bits-atomic-wide-counter-h+ nil)

(defparameter claylib/wrap::+%bits-byteswap-h+ 1)

(defparameter claylib/wrap::+%bits-endianness-h+ 1)

(defparameter claylib/wrap::+%bits-endian-h+ 1)
...
(defparameter claylib/wrap::+%bits-pthreadtypes-arch-h+ 1)

(defparameter claylib/wrap::+%bits-pthreadtypes-common-h+ 1)

(defparameter claylib/wrap::+%bits-stdint-intn-h+ 1)
...
(defparameter claylib/wrap::+%bits-types-locale-t-h+ 1)

(defparameter claylib/wrap::+%bits-types---locale-t-h+ 1)

(defparameter claylib/wrap::+%bits-uintn-identity-h+ 1)

(defparameter claylib/wrap::+%default-source+ 1)

(defparameter claylib/wrap::+%dlfcn-h+ 1)

(defparameter claylib/wrap::+%endian-h+ 1)
...
(defparameter claylib/wrap::+%lp64+ 1)
...
(defparameter claylib/wrap::+%ptrdiff-t+ nil)

(defparameter claylib/wrap::+%rwlock-internal-h+ nil)

(defparameter claylib/wrap::+%sigset-nwords+ 16)
...
(defparameter claylib/wrap::+%strings-h+ 1)

(defparameter claylib/wrap::+%string-h+ 1)

(defparameter claylib/wrap::+%struct-timespec+ 1)

(defparameter claylib/wrap::+%sys-cdefs-h+ 1)

(defparameter claylib/wrap::+%sys-select-h+ 1)

(defparameter claylib/wrap::+%sys-types-h+ 1)

(defparameter claylib/wrap::+%thread-mutex-internal-h+ 1)
...
(defparameter claylib/wrap::+linux+ nil)
...
(defparameter claylib/wrap::+unix+ nil)

(cffi:defcenum (claylib/wrap::|C:@EA@BLEND-MODE| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:852:9"
               (:alpha 0)
               (:additive 1)
               (:multiplied 2)
               (:add-colors 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@CAMERA-MODE| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:879:9"
               (:custom 0)
               (:free 1)
               (:orbital 2)
               (:first-person 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@CAMERA-PROJECTION|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:888:9"
               (:perspective 0)
               (:orthographic 1))

(cffi:defbitfield (claylib/wrap::|C:@EA@CONFIG-FLAGS| :unsigned-int)
                  "/home/me/claylib/wrap/lib/raylib.h:502:9"
                  (:vsync-hint 64)
                  (:fullscreen-mode 2)
                  (:window-resizable 4)
...
(cffi:defcenum (claylib/wrap::|C:@EA@CUBEMAP-LAYOUT| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:835:9"
               (:auto-detect 0)
               (:line-vertical 1)
               (:line-horizontal 2)
...
(cffi:defcenum (claylib/wrap::|C:@EA@FONT-TYPE| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:845:9"
               (:default 0)
               (:bitmap 1)
               (:sdf 2))

(cffi:defcenum (claylib/wrap::|C:@EA@GAMEPAD-AXIS| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:707:9"
               (:left-x 0)
               (:left-y 1)
               (:right-x 2)
               (:right-y 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@GAMEPAD-BUTTON| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:685:9"
               (:unknown 0)
               (:left-face-up 1)
               (:left-face-right 2)
               (:left-face-down 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@GESTURE| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:864:9"
               (:none 0)
               (:tap 1)
               (:doubletap 2)
               (:hold 4)
...
(cffi:defbitfield (claylib/wrap::|C:@EA@GUI-CHECK-BOX-PROPERTY|
                   :unsigned-int)
                  "/home/me/claylib/wrap/lib/raygui.h:425:9"
                  (:check-padding 16))

(cffi:defcenum (claylib/wrap::|C:@EA@GUI-COLOR-PICKER-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:462:9"
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-COMBO-BOX-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:430:9"
               (:width 16)
               (:spacing 17))

(cffi:defcenum (claylib/wrap::|C:@EA@GUI-CONTROL| :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:337:9"
               (:default 0)
               (:label 1)
               (:button 2)
               (:toggle 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-CONTROL-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:360:9"
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-DEFAULT-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:385:9"
               (:text-size 16)
               (:text-spacing 17)
               (:line-color 18)
               (:background-color 19))
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-LIST-VIEW-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:454:9"
...
(cffi:defbitfield (claylib/wrap::|C:@EA@GUI-PROGRESS-BAR-PROPERTY|
                   :unsigned-int)
                  "/home/me/claylib/wrap/lib/raygui.h:410:9"
                  (:progress-padding 16))

(cffi:defcenum (claylib/wrap::|C:@EA@GUI-PROPERTY-ELEMENT|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:1150:9"
               (:border 0)
               (:base 1)
               (:text 2)
               (:other 3))
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-SCROLL-BAR-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:415:9"
               (:arrows-size 16)
               (:arrows-visible 17)
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-SLIDER-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:404:9"
               (:width 16)
               (:padding 17))

(cffi:defcenum (claylib/wrap::|C:@EA@GUI-SPINNER-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:448:9"
               (:width 16)
               (:spacing 17))

(cffi:defcenum (claylib/wrap::|C:@EA@GUI-STATE| :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:322:9"
               (:normal 0)
               (:focused 1)
               (:pressed 2)
               (:disabled 3))
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-TEXT-ALIGNMENT|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:330:9"
               (:left 0)
               (:center 1)
               (:right 2))
...
(cffi:defcenum (claylib/wrap::|C:@EA@GUI-TEXT-BOX-PROPERTY|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raygui.h:442:9"
               (:inner-padding 16)
               (:lines-spacing 17))
...
(cffi:defcenum (claylib/wrap::|C:@EA@KEYBOARD-KEY| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:536:9"
               (:null 0)
               (:apostrophe 39)
               (:comma 44)
               (:minus 45)
...
(cffi:defcenum (claylib/wrap::|C:@EA@MATERIAL-MAP-INDEX|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:717:9"
               (:albedo 0)
               (:metalness 1)
               (:normal 2)
               (:roughness 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@MOUSE-BUTTON| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:659:9"
               (:left 0)
               (:right 1)
               (:middle 2)
               (:side 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@MOUSE-CURSOR| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:670:9"
               (:default 0)
               (:arrow 1)
               (:ibeam 2)
               (:crosshair 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@SHADER-ATTRIBUTE-DATA-TYPE|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:781:9"
               (:float 0)
               (:vec2 1)
               (:vec3 2)
               (:vec4 3))
...
(cffi:defcenum (claylib/wrap::|C:@EA@SHADER-LOCATION-INDEX|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:735:9"
               (:vertex-position 0)
               (:vertex-texcoord01 1)
               (:vertex-texcoord02 2)
               (:vertex-normal 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@SHADER-UNIFORM-DATA-TYPE|
                :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:768:9"
               (:float 0)
               (:vec2 1)
               (:vec3 2)
               (:vec4 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@TEXTURE-FILTER| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:817:9"
               (:point 0)
               (:bilinear 1)
               (:trilinear 2)
               (:anisotropic-4x 3)
...
(cffi:defcenum (claylib/wrap::|C:@EA@TEXTURE-WRAP| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:827:9"
               (:repeat 0)
               (:clamp 1)
               (:mirror-repeat 2)
               (:mirror-clamp 3))
...
(cffi:defcenum (claylib/wrap::|C:@EA@TRACE-LOG-LEVEL| :unsigned-int)
               "/home/me/claylib/wrap/lib/raylib.h:522:9"
               (:all 0)
               (:trace 1)
               (:debug 2)
               (:info 3)
...
(cffi:defcstruct (claylib/wrap::image :size 24)
                 ...
                 (claylib/wrap::format :int :offset 20))
...
(cffi:defcfun ("GuiSliderPro" claylib/wrap::gui-slider-pro)
              :float
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text-left :string)
...
(cffi:defcfun ("Vector2Add" claylib/wrap::vector2-add)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2AddValue" claylib/wrap::vector2-add-value)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("Vector2Angle" claylib/wrap::vector2-angle)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Clamp" claylib/wrap::vector2-clamp)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("Vector2ClampValue" claylib/wrap::vector2-clamp-value)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::min :float)
...
(cffi:defcfun ("Vector2Distance" claylib/wrap::vector2-distance)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Divide" claylib/wrap::vector2-divide)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2DotProduct" claylib/wrap::vector2-dot-product)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Equals" claylib/wrap::vector2-equals)
              :int
...
(cffi:defcfun ("Vector2Invert" claylib/wrap::vector2-invert)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Length" claylib/wrap::vector2-length)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector2-length-sqr))

(cffi:defcfun ("Vector2LengthSqr" claylib/wrap::vector2-length-sqr)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector2-lerp))

(cffi:defcfun ("Vector2Lerp" claylib/wrap::vector2-lerp)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("Vector2Multiply" claylib/wrap::vector2-multiply)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Negate" claylib/wrap::vector2-negate)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Normalize" claylib/wrap::vector2-normalize)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2One" claylib/wrap::vector2-one)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector2-reflect))

(cffi:defcfun ("Vector2Reflect" claylib/wrap::vector2-reflect)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("Vector2Rotate" claylib/wrap::vector2-rotate)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("Vector2Scale" claylib/wrap::vector2-scale)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::scale :float))
...
(cffi:defcfun ("Vector2Subtract" claylib/wrap::vector2-subtract)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("Vector2Transform" claylib/wrap::vector2-transform)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::mat (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("Vector2Zero" claylib/wrap::vector2-zero)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector3-add))

(cffi:defcfun ("Vector3Add" claylib/wrap::vector3-add)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3AddValue" claylib/wrap::vector3-add-value)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Angle" claylib/wrap::vector3-angle)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Barycenter" claylib/wrap::vector3-barycenter)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Clamp" claylib/wrap::vector3-clamp)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3ClampValue" claylib/wrap::vector3-clamp-value)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::min :float)
...
(cffi:defcfun ("Vector3Distance" claylib/wrap::vector3-distance)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Divide" claylib/wrap::vector3-divide)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3DotProduct" claylib/wrap::vector3-dot-product)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Equals" claylib/wrap::vector3-equals)
              :int
              (claylib/wrap::p (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Invert" claylib/wrap::vector3-invert)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Length" claylib/wrap::vector3-length)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))

(declaim (inline claylib/wrap::vector3-length-sqr))

(cffi:defcfun ("Vector3LengthSqr" claylib/wrap::vector3-length-sqr)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))

(declaim (inline claylib/wrap::vector3-lerp))

(cffi:defcfun ("Vector3Lerp" claylib/wrap::vector3-lerp)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Max" claylib/wrap::vector3-max)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Min" claylib/wrap::vector3-min)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Multiply" claylib/wrap::vector3-multiply)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Negate" claylib/wrap::vector3-negate)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Normalize" claylib/wrap::vector3-normalize)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3One" claylib/wrap::vector3-one)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3Reflect" claylib/wrap::vector3-reflect)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Refract" claylib/wrap::vector3-refract)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Scale" claylib/wrap::vector3-scale)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Subtract" claylib/wrap::vector3-subtract)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("Vector3ToFloatV" claylib/wrap::vector3-to-float-v)
...
(cffi:defcfun ("Vector3Transform" claylib/wrap::vector3-transform)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::mat (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("Vector3Unproject" claylib/wrap::vector3-unproject)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("Vector3Zero" claylib/wrap::vector3-zero)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_AttachAudioStreamProcessor"
               claylib/wrap::attach-audio-stream-processor)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_BeginMode2D" claylib/wrap::begin-mode2d)
              :void
              (claylib/wrap::camera
               (:pointer claylib/wrap::camera2d)))
...
(cffi:defcfun ("__claw_BeginMode3D" claylib/wrap::begin-mode3d)
              :void
              (claylib/wrap::camera
               (:pointer claylib/wrap::camera3d)))
...
(cffi:defcfun ("__claw_BeginShaderMode"
...
(cffi:defcfun ("__claw_BeginTextureMode"
...
(cffi:defcfun ("__claw_BeginVrStereoMode"
               claylib/wrap::begin-vr-stereo-mode)
              :void
              (claylib/wrap::config
               (:pointer claylib/wrap::vr-stereo-config)))
...
(cffi:defcfun ("__claw_CheckCollisionBoxSphere"
               claylib/wrap::check-collision-box-sphere)
              :bool
              (claylib/wrap::box
               (:pointer claylib/wrap::bounding-box))
...
(cffi:defcfun ("__claw_CheckCollisionBoxes"
               claylib/wrap::check-collision-boxes)
              :bool
              (claylib/wrap::box1
               (:pointer claylib/wrap::bounding-box))
...
(cffi:defcfun ("__claw_CheckCollisionCircleRec"
               claylib/wrap::check-collision-circle-rec)
              :bool
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_CheckCollisionCircles"
               claylib/wrap::check-collision-circles)
              :bool
              (claylib/wrap::center1
               (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_CheckCollisionLines"
               claylib/wrap::check-collision-lines)
              :bool
              (claylib/wrap::start-pos1
               (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_CheckCollisionPointCircle"
               claylib/wrap::check-collision-point-circle)
              :bool
              (claylib/wrap::point (:pointer claylib/wrap::vector2))
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_CheckCollisionPointLine"
               claylib/wrap::check-collision-point-line)
              :bool
              (claylib/wrap::point (:pointer claylib/wrap::vector2))
              (claylib/wrap::p1 (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_CheckCollisionPointRec"
               claylib/wrap::check-collision-point-rec)
              :bool
              (claylib/wrap::point (:pointer claylib/wrap::vector2))
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle)))
...
(cffi:defcfun ("__claw_CheckCollisionPointTriangle"
               claylib/wrap::check-collision-point-triangle)
              :bool
              (claylib/wrap::point (:pointer claylib/wrap::vector2))
              (claylib/wrap::p1 (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_CheckCollisionRecs"
               claylib/wrap::check-collision-recs)
              :bool
              (claylib/wrap::rec1 (:pointer claylib/wrap::rectangle))
              (claylib/wrap::rec2 (:pointer claylib/wrap::rectangle)))
...
(cffi:defcfun ("__claw_CheckCollisionSpheres"
               claylib/wrap::check-collision-spheres)
              :bool
              (claylib/wrap::center1
               (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Clamp" claylib/wrap::clamp)
              :float
              (claylib/wrap::value :float)
              (claylib/wrap::min :float)
              (claylib/wrap::max :float))
...
(cffi:defcfun ("__claw_ClearBackground"
...
(cffi:defcfun ("__claw_ColorAlpha" claylib/wrap::color-alpha)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::color (:pointer claylib/wrap::color))
              (claylib/wrap::alpha :float))
...
(cffi:defcfun ("__claw_ColorAlphaBlend"
...
(cffi:defcfun ("__claw_ColorFromHSV" claylib/wrap::color-from-hsv)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::hue :float)
              (claylib/wrap::saturation :float)
...
(cffi:defcfun ("__claw_ColorFromNormalized"
               claylib/wrap::color-from-normalized)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::normalized
...
(cffi:defcfun ("__claw_ColorNormalize" claylib/wrap::color-normalize)
              (:pointer claylib/wrap::vector4)
              (claylib/wrap::result (:pointer claylib/wrap::vector4))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_ColorToHSV" claylib/wrap::color-to-hsv)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_ColorToInt" claylib/wrap::color-to-int)
              :int
              (claylib/wrap::color (:pointer claylib/wrap::color)))

(declaim (inline claylib/wrap::detach-audio-stream-processor))

(cffi:defcfun ("__claw_DetachAudioStreamProcessor"
               claylib/wrap::detach-audio-stream-processor)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_DrawBillboard" claylib/wrap::draw-billboard)
              :void
              (claylib/wrap::camera (:pointer claylib/wrap::camera))
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
...
(cffi:defcfun ("__claw_DrawBillboardPro"
...
(cffi:defcfun ("__claw_DrawBillboardRec"
...
(cffi:defcfun ("__claw_DrawBoundingBox"
...
(cffi:defcfun ("__claw_DrawCircle" claylib/wrap::draw-circle)
              :void
              (claylib/wrap::center-x :int)
              (claylib/wrap::center-y :int)
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawCircle3D" claylib/wrap::draw-circle3d)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector3))
              (claylib/wrap::radius :float)
              (claylib/wrap::rotation-axis
...
(cffi:defcfun ("__claw_DrawCircleGradient"
               claylib/wrap::draw-circle-gradient)
              :void
              (claylib/wrap::center-x :int)
              (claylib/wrap::center-y :int)
...
(cffi:defcfun ("__claw_DrawCircleLines"
...
(cffi:defcfun ("__claw_DrawCircleSector"
...
(cffi:defcfun ("__claw_DrawCircleSectorLines"
               claylib/wrap::draw-circle-sector-lines)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawCircleV" claylib/wrap::draw-circle-v)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::radius :float)
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawCube" claylib/wrap::draw-cube)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::width :float)
...
(cffi:defcfun ("__claw_DrawCubeTexture"
               claylib/wrap::draw-cube-texture)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_DrawCubeTextureRec"
               claylib/wrap::draw-cube-texture-rec)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
...
(cffi:defcfun ("__claw_DrawCubeV" claylib/wrap::draw-cube-v)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::size (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_DrawCubeWires" claylib/wrap::draw-cube-wires)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::width :float)
...
(cffi:defcfun ("__claw_DrawCubeWiresV"
...
(cffi:defcfun ("__claw_DrawCylinder" claylib/wrap::draw-cylinder)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::radius-top :float)
...
(cffi:defcfun ("__claw_DrawCylinderEx"
...
(cffi:defcfun ("__claw_DrawCylinderWires"
...
(cffi:defcfun ("__claw_DrawCylinderWiresEx"
               claylib/wrap::draw-cylinder-wires-ex)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_DrawEllipse" claylib/wrap::draw-ellipse)
              :void
              (claylib/wrap::center-x :int)
              (claylib/wrap::center-y :int)
              (claylib/wrap::radius-h :float)
...
(cffi:defcfun ("__claw_DrawEllipseLines"
...
(cffi:defcfun ("__claw_DrawLine" claylib/wrap::draw-line)
              :void
              (claylib/wrap::start-pos-x :int)
              (claylib/wrap::start-pos-y :int)
              (claylib/wrap::end-pos-x :int)
...
(cffi:defcfun ("__claw_DrawLine3D" claylib/wrap::draw-line3d)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::end-pos
...
(cffi:defcfun ("__claw_DrawLineBezier"
...
(cffi:defcfun ("__claw_DrawLineBezierCubic"
               claylib/wrap::draw-line-bezier-cubic)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawLineBezierQuad"
               claylib/wrap::draw-line-bezier-quad)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawLineEx" claylib/wrap::draw-line-ex)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector2))
              (claylib/wrap::end-pos
...
(cffi:defcfun ("__claw_DrawLineStrip" claylib/wrap::draw-line-strip)
              :void
              (claylib/wrap::points (:pointer claylib/wrap::vector2))
              (claylib/wrap::point-count :int)
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawLineV" claylib/wrap::draw-line-v)
              :void
              (claylib/wrap::start-pos
               (:pointer claylib/wrap::vector2))
              (claylib/wrap::end-pos
...
(cffi:defcfun ("__claw_DrawMesh" claylib/wrap::draw-mesh)
              :void
              (claylib/wrap::mesh (:pointer claylib/wrap::mesh))
              (claylib/wrap::material
               (:pointer claylib/wrap::material))
...
(cffi:defcfun ("__claw_DrawMeshInstanced"
...
(cffi:defcfun ("__claw_DrawModel" claylib/wrap::draw-model)
              :void
              (claylib/wrap::model (:pointer claylib/wrap::model))
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_DrawModelEx" claylib/wrap::draw-model-ex)
              :void
              (claylib/wrap::model (:pointer claylib/wrap::model))
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_DrawModelWires"
...
(cffi:defcfun ("__claw_DrawModelWiresEx"
...
(cffi:defcfun ("__claw_DrawPixel" claylib/wrap::draw-pixel)
              :void
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawPixelV" claylib/wrap::draw-pixel-v)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector2))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawPlane" claylib/wrap::draw-plane)
              :void
              (claylib/wrap::center-pos
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::size (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawPoint3D" claylib/wrap::draw-point3d)
              :void
              (claylib/wrap::position
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawPoly" claylib/wrap::draw-poly)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::sides :int)
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawPolyLines" claylib/wrap::draw-poly-lines)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::sides :int)
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawPolyLinesEx"
...
(cffi:defcfun ("__claw_DrawRay" claylib/wrap::draw-ray)
              :void
              (claylib/wrap::ray (:pointer claylib/wrap::ray))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_DrawRectangle" claylib/wrap::draw-rectangle)
              :void
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_DrawRectangleGradientEx"
               claylib/wrap::draw-rectangle-gradient-ex)
              :void
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
              (claylib/wrap::col1 (:pointer claylib/wrap::color))
...
(cffi:defcfun ("__claw_DrawRectangleGradientH"
               claylib/wrap::draw-rectangle-gradient-h)
              :void
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
...
(cffi:defcfun ("__claw_DrawRectangleGradientV"
               claylib/wrap::draw-rectangle-gradient-v)
              :void
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
...
(cffi:defcfun ("__claw_DrawRectangleLines"
               claylib/wrap::draw-rectangle-lines)
              :void
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
...
(cffi:defcfun ("__claw_DrawRectangleLinesEx"
               claylib/wrap::draw-rectangle-lines-ex)
              :void
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
              (claylib/wrap::line-thick :float)
...
(cffi:defcfun ("__claw_DrawRectanglePro"
...
(cffi:defcfun ("__claw_DrawRectangleRec"
...
(cffi:defcfun ("__claw_DrawRectangleRounded"
               claylib/wrap::draw-rectangle-rounded)
              :void
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
              (claylib/wrap::roundness :float)
...
(cffi:defcfun ("__claw_DrawRectangleRoundedLines"
               claylib/wrap::draw-rectangle-rounded-lines)
              :void
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
              (claylib/wrap::roundness :float)
...
(cffi:defcfun ("__claw_DrawRectangleV"
...
(cffi:defcfun ("__claw_DrawRing" claylib/wrap::draw-ring)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::inner-radius :float)
              (claylib/wrap::outer-radius :float)
...
(cffi:defcfun ("__claw_DrawRingLines" claylib/wrap::draw-ring-lines)
              :void
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
              (claylib/wrap::inner-radius :float)
              (claylib/wrap::outer-radius :float)
...
(cffi:defcfun ("__claw_DrawSphere" claylib/wrap::draw-sphere)
              :void
              (claylib/wrap::center-pos
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawSphereEx" claylib/wrap::draw-sphere-ex)
              :void
              (claylib/wrap::center-pos
               (:pointer claylib/wrap::vector3))
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_DrawSphereWires"
...
(cffi:defcfun ("__claw_DrawText" claylib/wrap::draw-text)
              :void
              (claylib/wrap::text :string)
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
...
(cffi:defcfun ("__claw_DrawTextCodepoint"
...
(cffi:defcfun ("__claw_DrawTextCodepoints"
               claylib/wrap::draw-text-codepoints)
              :void
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::codepoints (:pointer :int))
...
(cffi:defcfun ("__claw_DrawTextEx" claylib/wrap::draw-text-ex)
              :void
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::text :string)
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_DrawTextPro" claylib/wrap::draw-text-pro)
              :void
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::text :string)
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_DrawTexture" claylib/wrap::draw-texture)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::pos-x :int)
...
(cffi:defcfun ("__claw_DrawTextureEx" claylib/wrap::draw-texture-ex)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_DrawTextureNPatch"
               claylib/wrap::draw-texture-n-patch)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
...
(cffi:defcfun ("__claw_DrawTexturePoly"
               claylib/wrap::draw-texture-poly)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::center (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawTexturePro"
...
(cffi:defcfun ("__claw_DrawTextureQuad"
               claylib/wrap::draw-texture-quad)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::tiling (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawTextureRec"
...
(cffi:defcfun ("__claw_DrawTextureTiled"
               claylib/wrap::draw-texture-tiled)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::source
...
(cffi:defcfun ("__claw_DrawTextureV" claylib/wrap::draw-texture-v)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_DrawTriangle" claylib/wrap::draw-triangle)
              :void
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v3 (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_DrawTriangle3D" claylib/wrap::draw-triangle3d)
              :void
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v3 (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_DrawTriangleFan"
...
(cffi:defcfun ("__claw_DrawTriangleLines"
...
(cffi:defcfun ("__claw_DrawTriangleStrip"
...
(cffi:defcfun ("__claw_DrawTriangleStrip3D"
               claylib/wrap::draw-triangle-strip3d)
              :void
              (claylib/wrap::points (:pointer claylib/wrap::vector3))
              (claylib/wrap::point-count :int)
...
(cffi:defcfun ("__claw_ExportFontAsCode"
...
(cffi:defcfun ("__claw_ExportImage" claylib/wrap::export-image)
              :bool
              (claylib/wrap::image (:pointer claylib/wrap::image))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_ExportImageAsCode"
               claylib/wrap::export-image-as-code)
              :bool
              (claylib/wrap::image (:pointer claylib/wrap::image))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_ExportMesh" claylib/wrap::export-mesh)
              :bool
              (claylib/wrap::mesh (:pointer claylib/wrap::mesh))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_ExportWave" claylib/wrap::export-wave)
              :bool
              (claylib/wrap::wave (:pointer claylib/wrap::wave))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_ExportWaveAsCode"
...
(cffi:defcfun ("__claw_Fade" claylib/wrap::fade)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::color (:pointer claylib/wrap::color))
              (claylib/wrap::alpha :float))
...
(cffi:defcfun ("__claw_FloatEquals" claylib/wrap::float-equals)
              :int
              (claylib/wrap::x :float)
              (claylib/wrap::y :float))
...
(cffi:defcfun ("__claw_GenImageCellular"
...
(cffi:defcfun ("__claw_GenImageChecked"
...
(cffi:defcfun ("__claw_GenImageColor" claylib/wrap::gen-image-color)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::width :int)
              (claylib/wrap::height :int)
...
(cffi:defcfun ("__claw_GenImageFontAtlas"
               claylib/wrap::gen-image-font-atlas)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::chars
...
(cffi:defcfun ("__claw_GenImageGradientH"
               claylib/wrap::gen-image-gradient-h)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_GenImageGradientRadial"
               claylib/wrap::gen-image-gradient-radial)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_GenImageGradientV"
               claylib/wrap::gen-image-gradient-v)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_GenImageWhiteNoise"
               claylib/wrap::gen-image-white-noise)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_GenMeshCone" claylib/wrap::gen-mesh-cone)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::radius :float)
              (claylib/wrap::height :float)
...
(cffi:defcfun ("__claw_GenMeshCube" claylib/wrap::gen-mesh-cube)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::width :float)
              (claylib/wrap::height :float)
...
(cffi:defcfun ("__claw_GenMeshCubicmap"
...
(cffi:defcfun ("__claw_GenMeshCylinder"
...
(cffi:defcfun ("__claw_GenMeshHeightmap"
...
(cffi:defcfun ("__claw_GenMeshHemiSphere"
               claylib/wrap::gen-mesh-hemi-sphere)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::radius :float)
...
(cffi:defcfun ("__claw_GenMeshKnot" claylib/wrap::gen-mesh-knot)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::radius :float)
              (claylib/wrap::size :float)
...
(cffi:defcfun ("__claw_GenMeshPlane" claylib/wrap::gen-mesh-plane)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::width :float)
              (claylib/wrap::length :float)
...
(cffi:defcfun ("__claw_GenMeshPoly" claylib/wrap::gen-mesh-poly)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::sides :int)
              (claylib/wrap::radius :float))
...
(cffi:defcfun ("__claw_GenMeshSphere" claylib/wrap::gen-mesh-sphere)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::radius :float)
              (claylib/wrap::rings :int)
...
(cffi:defcfun ("__claw_GenMeshTorus" claylib/wrap::gen-mesh-torus)
              (:pointer claylib/wrap::mesh)
              (claylib/wrap::result (:pointer claylib/wrap::mesh))
              (claylib/wrap::radius :float)
              (claylib/wrap::size :float)
...
(cffi:defcfun ("__claw_GetCameraMatrix"
...
(cffi:defcfun ("__claw_GetCameraMatrix2D"
               claylib/wrap::get-camera-matrix2d)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::camera
               (:pointer claylib/wrap::camera2d)))
...
(cffi:defcfun ("__claw_GetCollisionRec"
...
(cffi:defcfun ("__claw_GetColor" claylib/wrap::get-color)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::hex-value :unsigned-int))
...
(cffi:defcfun ("__claw_GetGlyphAtlasRec"
...
(cffi:defcfun ("__claw_GetGlyphIndex" claylib/wrap::get-glyph-index)
              :int
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::codepoint :int))
...
(cffi:defcfun ("__claw_GetGlyphInfo" claylib/wrap::get-glyph-info)
              (:pointer claylib/wrap::glyph-info)
              (claylib/wrap::result
               (:pointer claylib/wrap::glyph-info))
              (claylib/wrap::font (:pointer claylib/wrap::font))
...
(cffi:defcfun ("__claw_GetImageAlphaBorder"
               claylib/wrap::get-image-alpha-border)
              (:pointer claylib/wrap::rectangle)
              (claylib/wrap::result
               (:pointer claylib/wrap::rectangle))
...
(cffi:defcfun ("__claw_GetImageColor" claylib/wrap::get-image-color)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::image (:pointer claylib/wrap::image))
              (claylib/wrap::x :int)
...
(cffi:defcfun ("__claw_GetMeshBoundingBox"
               claylib/wrap::get-mesh-bounding-box)
              (:pointer claylib/wrap::bounding-box)
              (claylib/wrap::result
               (:pointer claylib/wrap::bounding-box))
...
(cffi:defcfun ("__claw_GetModelBoundingBox"
               claylib/wrap::get-model-bounding-box)
              (:pointer claylib/wrap::bounding-box)
              (claylib/wrap::result
               (:pointer claylib/wrap::bounding-box))
...
(cffi:defcfun ("__claw_GetMonitorPosition"
               claylib/wrap::get-monitor-position)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::monitor :int))
...
(cffi:defcfun ("__claw_GetMouseRay" claylib/wrap::get-mouse-ray)
              (:pointer claylib/wrap::ray)
              (claylib/wrap::result (:pointer claylib/wrap::ray))
              (claylib/wrap::mouse-position
               (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_GetMusicTimeLength"
               claylib/wrap::get-music-time-length)
              :float
              (claylib/wrap::music (:pointer claylib/wrap::music)))
...
(cffi:defcfun ("__claw_GetMusicTimePlayed"
               claylib/wrap::get-music-time-played)
              :float
              (claylib/wrap::music (:pointer claylib/wrap::music)))
...
(cffi:defcfun ("__claw_GetPixelColor" claylib/wrap::get-pixel-color)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::src-ptr (:pointer :void))
              (claylib/wrap::format :int))
...
(cffi:defcfun ("__claw_GetRayCollisionBox"
               claylib/wrap::get-ray-collision-box)
              (:pointer claylib/wrap::ray-collision)
              (claylib/wrap::result
               (:pointer claylib/wrap::ray-collision))
...
(cffi:defcfun ("__claw_GetRayCollisionMesh"
               claylib/wrap::get-ray-collision-mesh)
              (:pointer claylib/wrap::ray-collision)
              (claylib/wrap::result
               (:pointer claylib/wrap::ray-collision))
...
(cffi:defcfun ("__claw_GetRayCollisionQuad"
               claylib/wrap::get-ray-collision-quad)
              (:pointer claylib/wrap::ray-collision)
              (claylib/wrap::result
               (:pointer claylib/wrap::ray-collision))
...
(cffi:defcfun ("__claw_GetRayCollisionSphere"
               claylib/wrap::get-ray-collision-sphere)
              (:pointer claylib/wrap::ray-collision)
              (claylib/wrap::result
               (:pointer claylib/wrap::ray-collision))
...
(cffi:defcfun ("__claw_GetRayCollisionTriangle"
               claylib/wrap::get-ray-collision-triangle)
              (:pointer claylib/wrap::ray-collision)
              (claylib/wrap::result
               (:pointer claylib/wrap::ray-collision))
...
(cffi:defcfun ("__claw_GetScreenToWorld2D"
               claylib/wrap::get-screen-to-world2d)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_GetShaderLocation"
...
(cffi:defcfun ("__claw_GetShaderLocationAttrib"
               claylib/wrap::get-shader-location-attrib)
              :int
              (claylib/wrap::shader (:pointer claylib/wrap::shader))
              (claylib/wrap::attrib-name :string))
...
(cffi:defcfun ("__claw_GetTouchPosition"
...
(cffi:defcfun ("__claw_GetWorldToScreen"
...
(cffi:defcfun ("__claw_GetWorldToScreen2D"
               claylib/wrap::get-world-to-screen2d)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_GetWorldToScreenEx"
               claylib/wrap::get-world-to-screen-ex)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_GuiButton" claylib/wrap::gui-button)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiCheckBox" claylib/wrap::gui-check-box)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiColorBarAlpha"
...
(cffi:defcfun ("__claw_GuiColorBarHue"
...
(cffi:defcfun ("__claw_GuiColorPanel" claylib/wrap::gui-color-panel)
              (:pointer claylib/wrap::color)
              (claylib/wrap::result (:pointer claylib/wrap::color))
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
...
(cffi:defcfun ("__claw_GuiColorPicker"
...
(cffi:defcfun ("__claw_GuiComboBox" claylib/wrap::gui-combo-box)
              :int
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiDrawIcon" claylib/wrap::gui-draw-icon)
              :void
              (claylib/wrap::icon-id :int)
              (claylib/wrap::pos-x :int)
              (claylib/wrap::pos-y :int)
...
(cffi:defcfun ("__claw_GuiDropdownBox"
...
(cffi:defcfun ("__claw_GuiDummyRec" claylib/wrap::gui-dummy-rec)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiGrid" claylib/wrap::gui-grid)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
...
(cffi:defcfun ("__claw_GuiGroupBox" claylib/wrap::gui-group-box)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiLabel" claylib/wrap::gui-label)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiLabelButton"
...
(cffi:defcfun ("__claw_GuiLine" claylib/wrap::gui-line)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiListView" claylib/wrap::gui-list-view)
              :int
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiListViewEx" claylib/wrap::gui-list-view-ex)
              :int
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiMessageBox" claylib/wrap::gui-message-box)
              :int
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::title :string)
...
(cffi:defcfun ("__claw_GuiPanel" claylib/wrap::gui-panel)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiProgressBar"
...
(cffi:defcfun ("__claw_GuiScrollPanel"
...
(cffi:defcfun ("__claw_GuiSetFont" claylib/wrap::gui-set-font)
              :void
              (claylib/wrap::font (:pointer claylib/wrap::font)))

(declaim (inline claylib/wrap::gui-slider))

(cffi:defcfun ("__claw_GuiSlider" claylib/wrap::gui-slider)
              :float
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text-left :string)
...
(cffi:defcfun ("__claw_GuiSliderBar" claylib/wrap::gui-slider-bar)
              :float
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text-left :string)
...
(cffi:defcfun ("__claw_GuiSpinner" claylib/wrap::gui-spinner)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiStatusBar" claylib/wrap::gui-status-bar)
              :void
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string))
...
(cffi:defcfun ("__claw_GuiTextBox" claylib/wrap::gui-text-box)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiTextBoxMulti"
               claylib/wrap::gui-text-box-multi)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiTextInputBox"
...
(cffi:defcfun ("__claw_GuiToggle" claylib/wrap::gui-toggle)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiToggleGroup"
...
(cffi:defcfun ("__claw_GuiValueBox" claylib/wrap::gui-value-box)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_GuiWindowBox" claylib/wrap::gui-window-box)
              :bool
              (claylib/wrap::bounds
               (:pointer claylib/wrap::rectangle))
              (claylib/wrap::title :string))
...
(cffi:defcfun ("__claw_ImageAlphaClear"
...
(cffi:defcfun ("__claw_ImageAlphaMask"
...
(cffi:defcfun ("__claw_ImageClearBackground"
               claylib/wrap::image-clear-background)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::color (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_ImageColorReplace"
...
(cffi:defcfun ("__claw_ImageColorTint"
...
(cffi:defcfun ("__claw_ImageCopy" claylib/wrap::image-copy)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::image (:pointer claylib/wrap::image)))
...
(cffi:defcfun ("__claw_ImageCrop" claylib/wrap::image-crop)
              :void
              (claylib/wrap::image (:pointer claylib/wrap::image))
              (claylib/wrap::crop (:pointer claylib/wrap::rectangle)))
...
(cffi:defcfun ("__claw_ImageDraw" claylib/wrap::image-draw)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::src (:pointer claylib/wrap::image))
              (claylib/wrap::src-rec
...
(cffi:defcfun ("__claw_ImageDrawCircle"
...
(cffi:defcfun ("__claw_ImageDrawCircleV"
...
(cffi:defcfun ("__claw_ImageDrawLine" claylib/wrap::image-draw-line)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::start-pos-x :int)
              (claylib/wrap::start-pos-y :int)
...
(cffi:defcfun ("__claw_ImageDrawLineV"
...
(cffi:defcfun ("__claw_ImageDrawPixel"
...
(cffi:defcfun ("__claw_ImageDrawPixelV"
...
(cffi:defcfun ("__claw_ImageDrawRectangle"
               claylib/wrap::image-draw-rectangle)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::pos-x :int)
...
(cffi:defcfun ("__claw_ImageDrawRectangleLines"
               claylib/wrap::image-draw-rectangle-lines)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
...
(cffi:defcfun ("__claw_ImageDrawRectangleRec"
               claylib/wrap::image-draw-rectangle-rec)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::rec (:pointer claylib/wrap::rectangle))
...
(cffi:defcfun ("__claw_ImageDrawRectangleV"
               claylib/wrap::image-draw-rectangle-v)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::position
...
(cffi:defcfun ("__claw_ImageDrawText" claylib/wrap::image-draw-text)
              :void
              (claylib/wrap::dst (:pointer claylib/wrap::image))
              (claylib/wrap::text :string)
              (claylib/wrap::pos-x :int)
...
(cffi:defcfun ("__claw_ImageDrawTextEx"
...
(cffi:defcfun ("__claw_ImageFromImage"
...
(cffi:defcfun ("__claw_ImageResizeCanvas"
...
(cffi:defcfun ("__claw_ImageText" claylib/wrap::image-text)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::text :string)
              (claylib/wrap::font-size :int)
...
(cffi:defcfun ("__claw_ImageTextEx" claylib/wrap::image-text-ex)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_ImageToPOT" claylib/wrap::image-to-pot)
              :void
              (claylib/wrap::image (:pointer claylib/wrap::image))
              (claylib/wrap::fill (:pointer claylib/wrap::color)))
...
(cffi:defcfun ("__claw_IsAudioStreamPlaying"
               claylib/wrap::is-audio-stream-playing)
              :bool
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream)))
...
(cffi:defcfun ("__claw_IsAudioStreamProcessed"
               claylib/wrap::is-audio-stream-processed)
              :bool
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream)))
...
(cffi:defcfun ("__claw_IsModelAnimationValid"
               claylib/wrap::is-model-animation-valid)
              :bool
              (claylib/wrap::model (:pointer claylib/wrap::model))
              (claylib/wrap::anim
...
(cffi:defcfun ("__claw_IsMusicStreamPlaying"
               claylib/wrap::is-music-stream-playing)
              :bool
              (claylib/wrap::music (:pointer claylib/wrap::music)))
...
(cffi:defcfun ("__claw_IsSoundPlaying"
...
(cffi:defcfun ("__claw_Lerp" claylib/wrap::lerp)
              :float
              (claylib/wrap::start :float)
              (claylib/wrap::end :float)
              (claylib/wrap::amount :float))
...
(cffi:defcfun ("__claw_LoadAudioStream"
...
(cffi:defcfun ("__claw_LoadDirectoryFiles"
               claylib/wrap::load-directory-files)
              (:pointer claylib/wrap::file-path-list)
              (claylib/wrap::result
               (:pointer claylib/wrap::file-path-list))
...
(cffi:defcfun ("__claw_LoadDirectoryFilesEx"
               claylib/wrap::load-directory-files-ex)
              (:pointer claylib/wrap::file-path-list)
              (claylib/wrap::result
               (:pointer claylib/wrap::file-path-list))
...
(cffi:defcfun ("__claw_LoadFont" claylib/wrap::load-font)
              (:pointer claylib/wrap::font)
              (claylib/wrap::result (:pointer claylib/wrap::font))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadFontEx" claylib/wrap::load-font-ex)
              (:pointer claylib/wrap::font)
              (claylib/wrap::result (:pointer claylib/wrap::font))
              (claylib/wrap::file-name :string)
              (claylib/wrap::font-size :int)
...
(cffi:defcfun ("__claw_LoadFontFromImage"
               claylib/wrap::load-font-from-image)
              (:pointer claylib/wrap::font)
              (claylib/wrap::result (:pointer claylib/wrap::font))
              (claylib/wrap::image (:pointer claylib/wrap::image))
...
(cffi:defcfun ("__claw_LoadFontFromMemory"
               claylib/wrap::load-font-from-memory)
              (:pointer claylib/wrap::font)
              (claylib/wrap::result (:pointer claylib/wrap::font))
              (claylib/wrap::file-type :string)
...
(cffi:defcfun ("__claw_LoadImage" claylib/wrap::load-image)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadImageAnim" claylib/wrap::load-image-anim)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::file-name :string)
              (claylib/wrap::frames (:pointer :int)))
...
(cffi:defcfun ("__claw_LoadImageColors"
...
(cffi:defcfun ("__claw_LoadImageFromMemory"
               claylib/wrap::load-image-from-memory)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::file-type :string)
...
(cffi:defcfun ("__claw_LoadImageFromTexture"
               claylib/wrap::load-image-from-texture)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::texture
...
(cffi:defcfun ("__claw_LoadImagePalette"
...
(cffi:defcfun ("__claw_LoadImageRaw" claylib/wrap::load-image-raw)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image))
              (claylib/wrap::file-name :string)
              (claylib/wrap::width :int)
...
(cffi:defcfun ("__claw_LoadModel" claylib/wrap::load-model)
              (:pointer claylib/wrap::model)
              (claylib/wrap::result (:pointer claylib/wrap::model))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadModelFromMesh"
               claylib/wrap::load-model-from-mesh)
              (:pointer claylib/wrap::model)
              (claylib/wrap::result (:pointer claylib/wrap::model))
              (claylib/wrap::mesh (:pointer claylib/wrap::mesh)))
...
(cffi:defcfun ("__claw_LoadMusicStream"
...
(cffi:defcfun ("__claw_LoadMusicStreamFromMemory"
               claylib/wrap::load-music-stream-from-memory)
              (:pointer claylib/wrap::music)
              (claylib/wrap::result (:pointer claylib/wrap::music))
              (claylib/wrap::file-type :string)
...
(cffi:defcfun ("__claw_LoadRenderTexture"
...
(cffi:defcfun ("__claw_LoadShader" claylib/wrap::load-shader)
              (:pointer claylib/wrap::shader)
              (claylib/wrap::result (:pointer claylib/wrap::shader))
              (claylib/wrap::vs-file-name :string)
              (claylib/wrap::fs-file-name :string))
...
(cffi:defcfun ("__claw_LoadShaderFromMemory"
               claylib/wrap::load-shader-from-memory)
              (:pointer claylib/wrap::shader)
              (claylib/wrap::result (:pointer claylib/wrap::shader))
              (claylib/wrap::vs-code :string)
...
(cffi:defcfun ("__claw_LoadSound" claylib/wrap::load-sound)
              (:pointer claylib/wrap::sound)
              (claylib/wrap::result (:pointer claylib/wrap::sound))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadSoundFromWave"
               claylib/wrap::load-sound-from-wave)
              (:pointer claylib/wrap::sound)
              (claylib/wrap::result (:pointer claylib/wrap::sound))
              (claylib/wrap::wave (:pointer claylib/wrap::wave)))
...
(cffi:defcfun ("__claw_LoadTexture" claylib/wrap::load-texture)
              (:pointer claylib/wrap::texture2d)
              (claylib/wrap::result
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadTextureCubemap"
               claylib/wrap::load-texture-cubemap)
              (:pointer claylib/wrap::texture-cubemap)
              (claylib/wrap::result
               (:pointer claylib/wrap::texture-cubemap))
...
(cffi:defcfun ("__claw_LoadTextureFromImage"
               claylib/wrap::load-texture-from-image)
              (:pointer claylib/wrap::texture2d)
              (claylib/wrap::result
               (:pointer claylib/wrap::texture2d))
...
(cffi:defcfun ("__claw_LoadVrStereoConfig"
               claylib/wrap::load-vr-stereo-config)
              (:pointer claylib/wrap::vr-stereo-config)
              (claylib/wrap::result
               (:pointer claylib/wrap::vr-stereo-config))
...
(cffi:defcfun ("__claw_LoadWave" claylib/wrap::load-wave)
              (:pointer claylib/wrap::wave)
              (claylib/wrap::result (:pointer claylib/wrap::wave))
              (claylib/wrap::file-name :string))
...
(cffi:defcfun ("__claw_LoadWaveFromMemory"
               claylib/wrap::load-wave-from-memory)
              (:pointer claylib/wrap::wave)
              (claylib/wrap::result (:pointer claylib/wrap::wave))
              (claylib/wrap::file-type :string)
...
(cffi:defcfun ("__claw_LoadWaveSamples"
...
(cffi:defcfun ("__claw_MatrixAdd" claylib/wrap::matrix-add)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::left (:pointer claylib/wrap::matrix))
              (claylib/wrap::right (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("__claw_MatrixDeterminant"
...
(cffi:defcfun ("__claw_MatrixFrustum" claylib/wrap::matrix-frustum)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::left :double)
              (claylib/wrap::right :double)
...
(cffi:defcfun ("__claw_MatrixInvert" claylib/wrap::matrix-invert)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::mat (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("__claw_MatrixLookAt" claylib/wrap::matrix-look-at)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::eye (:pointer claylib/wrap::vector3))
              (claylib/wrap::target (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_MatrixMultiply" claylib/wrap::matrix-multiply)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::left (:pointer claylib/wrap::matrix))
              (claylib/wrap::right (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("__claw_MatrixOrtho" claylib/wrap::matrix-ortho)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::left :double)
              (claylib/wrap::right :double)
...
(cffi:defcfun ("__claw_MatrixPerspective"
...
(cffi:defcfun ("__claw_MatrixRotate" claylib/wrap::matrix-rotate)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::axis (:pointer claylib/wrap::vector3))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateX" claylib/wrap::matrix-rotate-x)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateXYZ"
...
(cffi:defcfun ("__claw_MatrixRotateY" claylib/wrap::matrix-rotate-y)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateZ" claylib/wrap::matrix-rotate-z)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("__claw_MatrixRotateZYX"
...
(cffi:defcfun ("__claw_MatrixScale" claylib/wrap::matrix-scale)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::x :float)
              (claylib/wrap::y :float)
...
(cffi:defcfun ("__claw_MatrixSubtract" claylib/wrap::matrix-subtract)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::left (:pointer claylib/wrap::matrix))
              (claylib/wrap::right (:pointer claylib/wrap::matrix)))
...
(cffi:defcfun ("__claw_MatrixToFloatV"
...
(cffi:defcfun ("__claw_MatrixTrace" claylib/wrap::matrix-trace)
              :float
              (claylib/wrap::mat (:pointer claylib/wrap::matrix)))

(declaim (inline claylib/wrap::matrix-translate))

(cffi:defcfun ("__claw_MatrixTranslate"
...
(cffi:defcfun ("__claw_MatrixTranspose"
...
(cffi:defcfun ("__claw_MeasureTextEx" claylib/wrap::measure-text-ex)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::font (:pointer claylib/wrap::font))
              (claylib/wrap::text :string)
...
(cffi:defcfun ("__claw_Normalize" claylib/wrap::normalize)
              :float
              (claylib/wrap::value :float)
              (claylib/wrap::start :float)
              (claylib/wrap::end :float))
...
(cffi:defcfun ("__claw_PauseAudioStream"
...
(cffi:defcfun ("__claw_PauseMusicStream"
...
(cffi:defcfun ("__claw_PauseSound" claylib/wrap::pause-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::play-audio-stream))

(cffi:defcfun ("__claw_PlayAudioStream"
...
(cffi:defcfun ("__claw_PlayMusicStream"
...
(cffi:defcfun ("__claw_PlaySound" claylib/wrap::play-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::play-sound-multi))

(cffi:defcfun ("__claw_PlaySoundMulti"
               claylib/wrap::play-sound-multi)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::quaternion-add))

(cffi:defcfun ("__claw_QuaternionAdd" claylib/wrap::quaternion-add)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
              (claylib/wrap::q1 (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionAddValue"
               claylib/wrap::quaternion-add-value)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionDivide"
...
(cffi:defcfun ("__claw_QuaternionEquals"
...
(cffi:defcfun ("__claw_QuaternionFromAxisAngle"
               claylib/wrap::quaternion-from-axis-angle)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionFromEuler"
               claylib/wrap::quaternion-from-euler)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionFromMatrix"
               claylib/wrap::quaternion-from-matrix)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionFromVector3ToVector3"
               claylib/wrap::quaternion-from-vector3to-vector3)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionInvert"
...
(cffi:defcfun ("__claw_QuaternionLength"
...
(cffi:defcfun ("__claw_QuaternionLerp" claylib/wrap::quaternion-lerp)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
              (claylib/wrap::q1 (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionMultiply"
               claylib/wrap::quaternion-multiply)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionNlerp"
...
(cffi:defcfun ("__claw_QuaternionNormalize"
               claylib/wrap::quaternion-normalize)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionScale"
...
(cffi:defcfun ("__claw_QuaternionSlerp"
...
(cffi:defcfun ("__claw_QuaternionSubtract"
               claylib/wrap::quaternion-subtract)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionSubtractValue"
               claylib/wrap::quaternion-subtract-value)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_QuaternionToAxisAngle"
               claylib/wrap::quaternion-to-axis-angle)
              :void
              (claylib/wrap::q (:pointer claylib/wrap::quaternion))
              (claylib/wrap::out-axis
...
(cffi:defcfun ("__claw_QuaternionToEuler"
...
(cffi:defcfun ("__claw_QuaternionToMatrix"
               claylib/wrap::quaternion-to-matrix)
              (:pointer claylib/wrap::matrix)
              (claylib/wrap::result (:pointer claylib/wrap::matrix))
              (claylib/wrap::q (:pointer claylib/wrap::quaternion)))
...
(cffi:defcfun ("__claw_QuaternionTransform"
               claylib/wrap::quaternion-transform)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion))
...
(cffi:defcfun ("__claw_Remap" claylib/wrap::remap)
              :float
              (claylib/wrap::value :float)
              (claylib/wrap::input-start :float)
              (claylib/wrap::input-end :float)
...
(cffi:defcfun ("__claw_ResumeAudioStream"
...
(cffi:defcfun ("__claw_ResumeMusicStream"
...
(cffi:defcfun ("__claw_ResumeSound" claylib/wrap::resume-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::seek-music-stream))

(cffi:defcfun ("__claw_SeekMusicStream"
...
(cffi:defcfun ("__claw_SetAudioStreamCallback"
               claylib/wrap::set-audio-stream-callback)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_SetAudioStreamPan"
               claylib/wrap::set-audio-stream-pan)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_SetAudioStreamPitch"
               claylib/wrap::set-audio-stream-pitch)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_SetAudioStreamVolume"
               claylib/wrap::set-audio-stream-volume)
              :void
              (claylib/wrap::stream
               (:pointer claylib/wrap::audio-stream))
...
(cffi:defcfun ("__claw_SetCameraMode" claylib/wrap::set-camera-mode)
              :void
              (claylib/wrap::camera (:pointer claylib/wrap::camera))
              (claylib/wrap::mode :int))
...
(cffi:defcfun ("__claw_SetMaterialTexture"
               claylib/wrap::set-material-texture)
              :void
              (claylib/wrap::material
               (:pointer claylib/wrap::material))
...
(cffi:defcfun ("__claw_SetMusicPan" claylib/wrap::set-music-pan)
              :void
              (claylib/wrap::music (:pointer claylib/wrap::music))
              (claylib/wrap::pan :float))
...
(cffi:defcfun ("__claw_SetMusicPitch" claylib/wrap::set-music-pitch)
              :void
              (claylib/wrap::music (:pointer claylib/wrap::music))
              (claylib/wrap::pitch :float))
...
(cffi:defcfun ("__claw_SetMusicVolume"
...
(cffi:defcfun ("__claw_SetPixelColor" claylib/wrap::set-pixel-color)
              :void
              (claylib/wrap::dst-ptr (:pointer :void))
              (claylib/wrap::color (:pointer claylib/wrap::color))
              (claylib/wrap::format :int))
...
(cffi:defcfun ("__claw_SetShaderValue"
...
(cffi:defcfun ("__claw_SetShaderValueMatrix"
               claylib/wrap::set-shader-value-matrix)
              :void
              (claylib/wrap::shader (:pointer claylib/wrap::shader))
              (claylib/wrap::loc-index :int)
...
(cffi:defcfun ("__claw_SetShaderValueTexture"
               claylib/wrap::set-shader-value-texture)
              :void
              (claylib/wrap::shader (:pointer claylib/wrap::shader))
              (claylib/wrap::loc-index :int)
...
(cffi:defcfun ("__claw_SetShaderValueV"
...
(cffi:defcfun ("__claw_SetShapesTexture"
...
(cffi:defcfun ("__claw_SetSoundPan" claylib/wrap::set-sound-pan)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound))
              (claylib/wrap::pan :float))
...
(cffi:defcfun ("__claw_SetSoundPitch" claylib/wrap::set-sound-pitch)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound))
              (claylib/wrap::pitch :float))
...
(cffi:defcfun ("__claw_SetSoundVolume"
...
(cffi:defcfun ("__claw_SetTextureFilter"
...
(cffi:defcfun ("__claw_SetTextureWrap"
...
(cffi:defcfun ("__claw_SetWindowIcon" claylib/wrap::set-window-icon)
              :void
              (claylib/wrap::image (:pointer claylib/wrap::image)))

(declaim (inline claylib/wrap::stop-audio-stream))

(cffi:defcfun ("__claw_StopAudioStream"
...
(cffi:defcfun ("__claw_StopMusicStream"
...
(cffi:defcfun ("__claw_StopSound" claylib/wrap::stop-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::unload-audio-stream))

(cffi:defcfun ("__claw_UnloadAudioStream"
...
(cffi:defcfun ("__claw_UnloadDirectoryFiles"
               claylib/wrap::unload-directory-files)
              :void
              (claylib/wrap::files
               (:pointer claylib/wrap::file-path-list)))
...
(cffi:defcfun ("__claw_UnloadDroppedFiles"
               claylib/wrap::unload-dropped-files)
              :void
              (claylib/wrap::files
               (:pointer claylib/wrap::file-path-list)))
...
(cffi:defcfun ("__claw_UnloadFont" claylib/wrap::unload-font)
              :void
              (claylib/wrap::font (:pointer claylib/wrap::font)))

(declaim (inline claylib/wrap::unload-image))

(cffi:defcfun ("__claw_UnloadImage" claylib/wrap::unload-image)
              :void
              (claylib/wrap::image (:pointer claylib/wrap::image)))

(declaim (inline claylib/wrap::unload-material))

(cffi:defcfun ("__claw_UnloadMaterial" claylib/wrap::unload-material)
              :void
              (claylib/wrap::material
               (:pointer claylib/wrap::material)))
...
(cffi:defcfun ("__claw_UnloadMesh" claylib/wrap::unload-mesh)
              :void
              (claylib/wrap::mesh (:pointer claylib/wrap::mesh)))

(declaim (inline claylib/wrap::unload-model))

(cffi:defcfun ("__claw_UnloadModel" claylib/wrap::unload-model)
              :void
              (claylib/wrap::model (:pointer claylib/wrap::model)))

(declaim (inline claylib/wrap::unload-model-animation))

(cffi:defcfun ("__claw_UnloadModelAnimation"
               claylib/wrap::unload-model-animation)
              :void
              (claylib/wrap::anim
               (:pointer claylib/wrap::model-animation)))
...
(cffi:defcfun ("__claw_UnloadModelKeepMeshes"
               claylib/wrap::unload-model-keep-meshes)
              :void
              (claylib/wrap::model (:pointer claylib/wrap::model)))
...
(cffi:defcfun ("__claw_UnloadMusicStream"
...
(cffi:defcfun ("__claw_UnloadRenderTexture"
               claylib/wrap::unload-render-texture)
              :void
              (claylib/wrap::target
               (:pointer claylib/wrap::render-texture2d)))
...
(cffi:defcfun ("__claw_UnloadShader" claylib/wrap::unload-shader)
              :void
              (claylib/wrap::shader (:pointer claylib/wrap::shader)))

(declaim (inline claylib/wrap::unload-sound))

(cffi:defcfun ("__claw_UnloadSound" claylib/wrap::unload-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound)))

(declaim (inline claylib/wrap::unload-texture))

(cffi:defcfun ("__claw_UnloadTexture" claylib/wrap::unload-texture)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d)))
...
(cffi:defcfun ("__claw_UnloadVrStereoConfig"
               claylib/wrap::unload-vr-stereo-config)
              :void
              (claylib/wrap::config
               (:pointer claylib/wrap::vr-stereo-config)))
...
(cffi:defcfun ("__claw_UnloadWave" claylib/wrap::unload-wave)
              :void
              (claylib/wrap::wave (:pointer claylib/wrap::wave)))

(declaim (inline claylib/wrap::update-audio-stream))

(cffi:defcfun ("__claw_UpdateAudioStream"
...
(cffi:defcfun ("__claw_UpdateMeshBuffer"
...
(cffi:defcfun ("__claw_UpdateModelAnimation"
               claylib/wrap::update-model-animation)
              :void
              (claylib/wrap::model (:pointer claylib/wrap::model))
              (claylib/wrap::anim
...
(cffi:defcfun ("__claw_UpdateMusicStream"
...
(cffi:defcfun ("__claw_UpdateSound" claylib/wrap::update-sound)
              :void
              (claylib/wrap::sound (:pointer claylib/wrap::sound))
              (claylib/wrap::data (:pointer :void))
              (claylib/wrap::sample-count :int))
...
(cffi:defcfun ("__claw_UpdateTexture" claylib/wrap::update-texture)
              :void
              (claylib/wrap::texture
               (:pointer claylib/wrap::texture2d))
              (claylib/wrap::pixels (:pointer :void)))
...
(cffi:defcfun ("__claw_UpdateTextureRec"
...
(cffi:defcfun ("__claw_Vector2Add" claylib/wrap::vector2-add)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2AddValue"
...
(cffi:defcfun ("__claw_Vector2Angle" claylib/wrap::vector2-angle)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Clamp" claylib/wrap::vector2-clamp)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::min (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_Vector2ClampValue"
...
(cffi:defcfun ("__claw_Vector2Distance"
...
(cffi:defcfun ("__claw_Vector2DistanceSqr"
               claylib/wrap::vector2-distance-sqr)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Divide" claylib/wrap::vector2-divide)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2DotProduct"
...
(cffi:defcfun ("__claw_Vector2Equals" claylib/wrap::vector2-equals)
              :int
              (claylib/wrap::p (:pointer claylib/wrap::vector2))
              (claylib/wrap::q (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Invert" claylib/wrap::vector2-invert)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Length" claylib/wrap::vector2-length)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector2-length-sqr))

(cffi:defcfun ("__claw_Vector2LengthSqr"
...
(cffi:defcfun ("__claw_Vector2Lerp" claylib/wrap::vector2-lerp)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector2))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_Vector2MoveTowards"
               claylib/wrap::vector2-move-towards)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_Vector2Multiply"
...
(cffi:defcfun ("__claw_Vector2Negate" claylib/wrap::vector2-negate)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Normalize"
...
(cffi:defcfun ("__claw_Vector2Reflect" claylib/wrap::vector2-reflect)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::normal (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_Vector2Rotate" claylib/wrap::vector2-rotate)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::angle :float))
...
(cffi:defcfun ("__claw_Vector2Scale" claylib/wrap::vector2-scale)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
              (claylib/wrap::scale :float))
...
(cffi:defcfun ("__claw_Vector2Subtract"
...
(cffi:defcfun ("__claw_Vector2SubtractValue"
               claylib/wrap::vector2-subtract-value)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2))
              (claylib/wrap::v (:pointer claylib/wrap::vector2))
...
(cffi:defcfun ("__claw_Vector2Transform"
...
(cffi:defcfun ("__claw_Vector3Add" claylib/wrap::vector3-add)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3AddValue"
...
(cffi:defcfun ("__claw_Vector3Angle" claylib/wrap::vector3-angle)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Barycenter"
...
(cffi:defcfun ("__claw_Vector3Clamp" claylib/wrap::vector3-clamp)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::min (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3ClampValue"
...
(cffi:defcfun ("__claw_Vector3CrossProduct"
               claylib/wrap::vector3-cross-product)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3Distance"
...
(cffi:defcfun ("__claw_Vector3DistanceSqr"
               claylib/wrap::vector3-distance-sqr)
              :float
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Divide" claylib/wrap::vector3-divide)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3DotProduct"
...
(cffi:defcfun ("__claw_Vector3Equals" claylib/wrap::vector3-equals)
              :int
              (claylib/wrap::p (:pointer claylib/wrap::vector3))
              (claylib/wrap::q (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Invert" claylib/wrap::vector3-invert)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Length" claylib/wrap::vector3-length)
              :float
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))

(declaim (inline claylib/wrap::vector3-length-sqr))

(cffi:defcfun ("__claw_Vector3LengthSqr"
...
(cffi:defcfun ("__claw_Vector3Lerp" claylib/wrap::vector3-lerp)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3Max" claylib/wrap::vector3-max)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Min" claylib/wrap::vector3-min)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Multiply"
...
(cffi:defcfun ("__claw_Vector3Negate" claylib/wrap::vector3-negate)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Normalize"
...
(cffi:defcfun ("__claw_Vector3OrthoNormalize"
               claylib/wrap::vector3-ortho-normalize)
              :void
              (claylib/wrap::v1 (:pointer claylib/wrap::vector3))
              (claylib/wrap::v2 (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Perpendicular"
               claylib/wrap::vector3-perpendicular)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Reflect" claylib/wrap::vector3-reflect)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::normal (:pointer claylib/wrap::vector3)))
...
(cffi:defcfun ("__claw_Vector3Refract" claylib/wrap::vector3-refract)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::n (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3RotateByAxisAngle"
               claylib/wrap::vector3-rotate-by-axis-angle)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3RotateByQuaternion"
               claylib/wrap::vector3-rotate-by-quaternion)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3Scale" claylib/wrap::vector3-scale)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
              (claylib/wrap::scalar :float))
...
(cffi:defcfun ("__claw_Vector3Subtract"
...
(cffi:defcfun ("__claw_Vector3SubtractValue"
               claylib/wrap::vector3-subtract-value)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3))
              (claylib/wrap::v (:pointer claylib/wrap::vector3))
...
(cffi:defcfun ("__claw_Vector3ToFloatV"
...
(cffi:defcfun ("__claw_Vector3Transform"
...
(cffi:defcfun ("__claw_Vector3Unproject"
...
(cffi:defcfun ("__claw_WaveCopy" claylib/wrap::wave-copy)
              (:pointer claylib/wrap::wave)
              (claylib/wrap::result (:pointer claylib/wrap::wave))
              (claylib/wrap::wave (:pointer claylib/wrap::wave)))
...
(cffi:defcfun ("__claw_Wrap" claylib/wrap::wrap)
              :float
              (claylib/wrap::value :float)
              (claylib/wrap::min :float)
              (claylib/wrap::max :float))
...
(cffi:defcfun ("__claw_acoshl" claylib/wrap::acoshl)
...
(cffi:defcfun ("__claw_acosl" claylib/wrap::acosl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_asinhl" claylib/wrap::asinhl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_asinl" claylib/wrap::asinl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_atan2l" claylib/wrap::atan2l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%y
...
(cffi:defcfun ("__claw_atanhl" claylib/wrap::atanhl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_atanl" claylib/wrap::atanl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_cE3AE40FE40GetFontDefault"
...
(cffi:defcfun ("__claw_cE3AE40FE40GetGestureDragVector"
               claylib/wrap::get-gesture-drag-vector)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_cE3AE40FE40GetGesturePinchVector"
               claylib/wrap::get-gesture-pinch-vector)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_cE3AE40FE40GetMouseDelta"
               claylib/wrap::get-mouse-delta)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::get-mouse-position))

(cffi:defcfun ("__claw_cE3AE40FE40GetMousePosition"
...
(cffi:defcfun ("__claw_cE3AE40FE40GetMouseWheelMoveV"
               claylib/wrap::get-mouse-wheel-move-v)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_cE3AE40FE40GetWindowPosition"
...
(cffi:defcfun ("__claw_cE3AE40FE40GetWindowScaleDPI"
               claylib/wrap::get-window-scale-dpi)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))
...
(cffi:defcfun ("__claw_cE3AE40FE40GuiGetFont"
               claylib/wrap::gui-get-font)
              (:pointer claylib/wrap::font)
              (claylib/wrap::result (:pointer claylib/wrap::font)))

(declaim (inline claylib/wrap::load-dropped-files))

(cffi:defcfun ("__claw_cE3AE40FE40LoadDroppedFiles"
...
(cffi:defcfun ("__claw_cE3AE40FE40LoadImageFromScreen"
               claylib/wrap::load-image-from-screen)
              (:pointer claylib/wrap::image)
              (claylib/wrap::result (:pointer claylib/wrap::image)))
...
(cffi:defcfun ("__claw_cE3AE40FE40LoadMaterialDefault"
               claylib/wrap::load-material-default)
              (:pointer claylib/wrap::material)
              (claylib/wrap::result
               (:pointer claylib/wrap::material)))
...
(cffi:defcfun ("__claw_cE3AE40FE40MatrixIdentity"
...
(cffi:defcfun ("__claw_cE3AE40FE40QuaternionIdentity"
               claylib/wrap::quaternion-identity)
              (:pointer claylib/wrap::quaternion)
              (claylib/wrap::result
               (:pointer claylib/wrap::quaternion)))
...
(cffi:defcfun ("__claw_cE3AE40FE40Vector2One"
               claylib/wrap::vector2-one)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector2-zero))

(cffi:defcfun ("__claw_cE3AE40FE40Vector2Zero"
               claylib/wrap::vector2-zero)
              (:pointer claylib/wrap::vector2)
              (claylib/wrap::result (:pointer claylib/wrap::vector2)))

(declaim (inline claylib/wrap::vector3-one))

(cffi:defcfun ("__claw_cE3AE40FE40Vector3One"
               claylib/wrap::vector3-one)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3)))

(declaim (inline claylib/wrap::vector3-zero))

(cffi:defcfun ("__claw_cE3AE40FE40Vector3Zero"
               claylib/wrap::vector3-zero)
              (:pointer claylib/wrap::vector3)
              (claylib/wrap::result (:pointer claylib/wrap::vector3)))

(declaim (inline claylib/wrap::erfcl))

(cffi:defcfun ("__claw_cE3AE40FE40erfcl" claylib/wrap::erfcl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40erfl" claylib/wrap::erfl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40gammal" claylib/wrap::gammal)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40j0l" claylib/wrap::j0l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40j1l" claylib/wrap::j1l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40jnl" claylib/wrap::jnl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
...
(cffi:defcfun ("__claw_cE3AE40FE40lgammal" claylib/wrap::lgammal)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40tgammal" claylib/wrap::tgammal)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40y0l" claylib/wrap::y0l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40y1l" claylib/wrap::y1l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_cE3AE40FE40ynl" claylib/wrap::ynl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0 :int)
...
(cffi:defcfun ("__claw_cbrtl" claylib/wrap::cbrtl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_ceill" claylib/wrap::ceill)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(declaim (inline
          claylib/wrap::claylib-makeshim-loader-9eff5374a00545cfaf5f7932850e4fbc5))

(cffi:defcfun ("__claw_claylib_makeshim_loader_9EFF5374A00545CFAF5F7932850E4FBC5"
               claylib/wrap::claylib-makeshim-loader-9eff5374a00545cfaf5f7932850e4fbc5)
              :int
              &rest)
...
(cffi:defcfun ("__claw_copysignl" claylib/wrap::copysignl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_coshl" claylib/wrap::coshl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_cosl" claylib/wrap::cosl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_dreml" claylib/wrap::dreml)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_exp2l" claylib/wrap::exp2l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_expl" claylib/wrap::expl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_expm1l" claylib/wrap::expm1l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fabsl" claylib/wrap::fabsl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fdiml" claylib/wrap::fdiml)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_finitel" claylib/wrap::finitel)
              :int
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_floorl" claylib/wrap::floorl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fmal" claylib/wrap::fmal)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fmaxl" claylib/wrap::fmaxl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fminl" claylib/wrap::fminl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_fmodl" claylib/wrap::fmodl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_frexpl" claylib/wrap::frexpl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_hypotl" claylib/wrap::hypotl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_ilogbl" claylib/wrap::ilogbl)
              :int
              (claylib/wrap::%%x
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_isinfl" claylib/wrap::isinfl)
              :int
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_isnanl" claylib/wrap::isnanl)
              :int
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_ldexpl" claylib/wrap::ldexpl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_lgammal_r" claylib/wrap::lgammal-r)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::arg0
...
(cffi:defcfun ("__claw_llrintl" claylib/wrap::llrintl)
              :long-long
              (claylib/wrap::%%x
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_llroundl" claylib/wrap::llroundl)
              :long-long
              (claylib/wrap::%%x
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_log10l" claylib/wrap::log10l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_log1pl" claylib/wrap::log1pl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_log2l" claylib/wrap::log2l)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_logbl" claylib/wrap::logbl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_logl" claylib/wrap::logl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_lrintl" claylib/wrap::lrintl)
              :long
              (claylib/wrap::%%x
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_lroundl" claylib/wrap::lroundl)
              :long
              (claylib/wrap::%%x
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_modfl" claylib/wrap::modfl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_nanl" claylib/wrap::nanl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
...
(cffi:defcfun ("__claw_nearbyintl" claylib/wrap::nearbyintl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_nextafterl" claylib/wrap::nextafterl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_nexttoward" claylib/wrap::nexttoward)
              :double
...
(cffi:defcfun ("__claw_nexttowardf" claylib/wrap::nexttowardf)
              :float
              (claylib/wrap::%%x :float)
              (claylib/wrap::%%y
               (:pointer claylib/wrap::long-double)))
...
(cffi:defcfun ("__claw_nexttowardl" claylib/wrap::nexttowardl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_powl" claylib/wrap::powl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_remainderl" claylib/wrap::remainderl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_remquol" claylib/wrap::remquol)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_rintl" claylib/wrap::rintl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_roundl" claylib/wrap::roundl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_scalbl" claylib/wrap::scalbl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_scalblnl" claylib/wrap::scalblnl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_scalbnl" claylib/wrap::scalbnl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_significandl" claylib/wrap::significandl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_sinhl" claylib/wrap::sinhl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_sinl" claylib/wrap::sinl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_sqrtl" claylib/wrap::sqrtl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_tanhl" claylib/wrap::tanhl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_tanl" claylib/wrap::tanl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcfun ("__claw_truncl" claylib/wrap::truncl)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%x
...
(cffi:defcstruct (claylib/wrap::%io-file :size 216))

(cffi:defcstruct (claylib/wrap::%io-file :size 216)
                 (claylib/wrap::%flags :int :offset 0)
                 (claylib/wrap::%io-read-ptr :string :offset 8)
                 (claylib/wrap::%io-read-end :string :offset 16)
                 (claylib/wrap::%io-read-base :string :offset 24)
                 (claylib/wrap::%io-write-base :string :offset 32)
                 (claylib/wrap::%io-write-ptr :string :offset 40)
                 (claylib/wrap::%io-write-end :string :offset 48)
                 (claylib/wrap::%io-buf-base :string :offset 56)
                 (claylib/wrap::%io-buf-end :string :offset 64)
                 (claylib/wrap::%io-save-base :string :offset 72)
                 (claylib/wrap::%io-backup-base :string :offset 80)
                 (claylib/wrap::%io-save-end :string :offset 88)
                 ...
                 (claylib/wrap::%chain
                  ...
                  104)
                 (claylib/wrap::%fileno :int :offset 112)
                 (claylib/wrap::%flags2 :int :offset 116)
                 (claylib/wrap::%cur-column :unsigned-short :offset
                  128)
                 (claylib/wrap::%vtable-offset :char :offset 130)
                 (claylib/wrap::%shortbuf :char :count 1 :offset 131)
                 ...
                 (claylib/wrap::%freeres-buf (:pointer :void) :offset
                  176)
                 (claylib/wrap::%mode :int :offset 192)
                 (claylib/wrap::%unused2 :char :count 20 :offset 196))
...
(declaim (inline claylib/wrap::dlclose))

(cffi:defcfun ("dlclose" claylib/wrap::dlclose)
              :int
              (claylib/wrap::%%handle (:pointer :void)))

(declaim (inline claylib/wrap::dlerror))

(cffi:defcfun ("dlerror" claylib/wrap::dlerror) :string)

(declaim (inline claylib/wrap::dlopen))

(cffi:defcfun ("dlopen" claylib/wrap::dlopen)
              (:pointer :void)
              (claylib/wrap::%%file :string)
              (claylib/wrap::%%mode :int))

(declaim (inline claylib/wrap::dlsym))

(cffi:defcfun ("dlsym" claylib/wrap::dlsym)
              (:pointer :void)
              (claylib/wrap::%%handle (:pointer :void))
...
(cffi:defcfun ("qecvt" claylib/wrap::qecvt)
              :string
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%ndigit :int)
...
(cffi:defcfun ("qfcvt" claylib/wrap::qfcvt)
              :string
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%ndigit :int)
...
(cffi:defcfun ("qgcvt" claylib/wrap::qgcvt)
              :string
              (claylib/wrap::%%value
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%ndigit :int)
...
(cffi:defcstruct (claylib/wrap::timeval :size 16))
...
(cffi:defcstruct (claylib/wrap::random-data :size 48)
                 (claylib/wrap::rand-type :int :offset 24)
                 (claylib/wrap::rand-deg :int :offset 28)
                 (claylib/wrap::rand-sep :int :offset 32))
...
(cffi:defcfun ("strtold" claylib/wrap::strtold)
              (:pointer claylib/wrap::long-double)
              (claylib/wrap::result
               (:pointer claylib/wrap::long-double))
              (claylib/wrap::%%nptr :string)
...
(cffi:defcstruct (claylib/wrap::timespec :size 16))
...
(cffi:defcstruct (claylib/wrap::|C:@SA@--SIGSET-T| :size 128)
                 (claylib/wrap::%%val :unsigned-long :count 16
                  :offset 0))
...
(cffi:defcstruct (claylib/wrap::|C:@SA@LDIV-T| :size 16)
                 (claylib/wrap::quot :long :offset 0)
                 (claylib/wrap::c-rem :long :offset 8))
...
(cffi:defcstruct (claylib/wrap::|C:@SA@MAX-ALIGN-T| :size 32)
                 (claylib/wrap::%%clang-max-align-nonce1 :long-long
                  :offset 0)
                 (claylib/wrap::%%clang-max-align-nonce2
                  claylib/wrap::long-double :offset 16))
...
(cffi:defcunion (claylib/wrap::|C:@UA@PTHREAD-BARRIER-T| :size 32)
...
(cffi:defcunion (claylib/wrap::|C:@UA@PTHREAD-MUTEX-T| :size 40)
                (claylib/wrap::%%size :char :count 40)
                (claylib/wrap::%%align :long))
...
(cffi:defcunion (claylib/wrap::|C:@UA@PTHREAD-RWLOCK-T| :size 56)
                (claylib/wrap::%%size :char :count 56)
                (claylib/wrap::%%align :long))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'claylib/wrap::|C:@SA@MAX-ALIGN-T| :claylib/wrap)
  ...
  (export 'claylib/wrap::dlerror :claylib/wrap)
  ...
  (export 'claylib/wrap::+linux+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-noload+ :claylib/wrap)
  ...
  (export 'claylib/wrap::dlclose :claylib/wrap)
  ...
  (export 'claylib/wrap::+unix+ :claylib/wrap)
  ...
  (export 'claylib/wrap::|C:@EA@GUI-COLOR-PICKER-PROPERTY|
          :claylib/wrap)
  (export 'claylib/wrap::+%ptrdiff-t+ :claylib/wrap)
  ...
  (export 'claylib/wrap::claylib-makeshim-loader-9eff5374a00545cfaf5f7932850e4fbc5
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-default+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-local+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-now+ :claylib/wrap)
  ...
  (export 'claylib/wrap::%%clang-max-align-nonce2 :claylib/wrap)
  ...
  (export 'claylib/wrap::+%dlfcn-h+ :claylib/wrap)
  ...
  (export 'claylib/wrap::dlsym :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-deepbind+ :claylib/wrap)
  ...
  (export 'claylib/wrap::dlopen :claylib/wrap)
  ...
  (export 'claylib/wrap::+%lp64+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-lazy+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-binding-mask+ :claylib/wrap)
  ...
  (export 'claylib/wrap::%%clang-max-align-nonce1 :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-next+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-nodelete+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+rtld-global+ :claylib/wrap)
