...
(defparameter claylib/wrap::+%%elf--+ 1)
...
(defparameter claylib/wrap::+%%float128--+ 1)
...
(defparameter claylib/wrap::+%%glibc-use-iec-60559-bfp-ext+ 1)

(defparameter claylib/wrap::+%%glibc-use-iec-60559-bfp-ext-c2x+ 1)

(defparameter claylib/wrap::+%%glibc-use-iec-60559-ext+ 1)

(defparameter claylib/wrap::+%%glibc-use-iec-60559-funcs-ext+ 1)

(defparameter claylib/wrap::+%%glibc-use-iec-60559-funcs-ext-c2x+ 1)

(defparameter claylib/wrap::+%%glibc-use-iec-60559-types-ext+ 1)

(defparameter claylib/wrap::+%%glibc-use-isoc2x+ 1)

(defparameter claylib/wrap::+%%glibc-use-lib-ext2+ 1)
...
(defparameter claylib/wrap::+%%intptr-fm-td--+ "d")

(defparameter claylib/wrap::+%%intptr-fm-ti--+ "i")
...
(defparameter claylib/wrap::+%%sizeof-float128--+ 16)

(defparameter claylib/wrap::+%%sizeof-float--+ 4)

(defparameter claylib/wrap::+%%sizeof-int--+ 4)

(defparameter claylib/wrap::+%%sizeof-long-double--+ 12)
...
(defparameter claylib/wrap::+%%size-fmtx--+ "X")

(defparameter claylib/wrap::+%%size-fm-to--+ "o")

(defparameter claylib/wrap::+%%size-fm-tu--+ "u")

(defparameter claylib/wrap::+%%size-fm-tx--+ "x")
...
(defparameter claylib/wrap::+%%uintptr-fmtx--+ "X")

(defparameter claylib/wrap::+%%uintptr-fm-to--+ "o")

(defparameter claylib/wrap::+%%uintptr-fm-tu--+ "u")

(defparameter claylib/wrap::+%%uintptr-fm-tx--+ "x")
...
(defparameter claylib/wrap::+%%wint-max--+ 4294967295)
...
(defparameter claylib/wrap::+%%gnu-linux--+ 1)

(defparameter claylib/wrap::+%%i386+ 1)

(defparameter claylib/wrap::+%%i386--+ 1)

(defparameter claylib/wrap::+%%linux+ 1)

(defparameter claylib/wrap::+%%linux--+ 1)

(defparameter claylib/wrap::+%%llvm--+ 1)

(defparameter claylib/wrap::+%%pentium4+ 1)
...
(defparameter claylib/wrap::+%%tune-pentium4--+ 1)

(defparameter claylib/wrap::+%%unix+ 1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'claylib/wrap::+%%pentium4--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%sizeof-float128--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%elf--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gnu-linux--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::logbf :claylib/wrap)
  (export 'claylib/wrap::+%%float128--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%tune-pentium4--+ :claylib/wrap)
