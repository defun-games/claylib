...
(defparameter claylib/wrap::+%%apple-cc--+ 6000)

(defparameter claylib/wrap::+%%apple--+ 1)
...
(defparameter claylib/wrap::+%%blocks--+ 1)
...
(defparameter claylib/wrap::+%%clang-atomic-llong-lock-free+ 1)
...
(defparameter claylib/wrap::+%%decimal-dig--+ 21)
...
(defparameter claylib/wrap::+%%decl-simd-tanhf128+ nil)
...
(defparameter claylib/wrap::+%%dynamic--+ 1)

(defparameter claylib/wrap::+%%end-decls+ nil)

(defparameter claylib/wrap::+%%environment-mac-os-x-version-min-required--+ 1040)
...
(defparameter claylib/wrap::+%%flt-eval-method--+ 2)
...
(defparameter claylib/wrap::+%%gcc-atomic-bool-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-char16-t-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-char32-t-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-char-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-int-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-llong-lock-free+ 1)

(defparameter claylib/wrap::+%%gcc-atomic-long-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-pointer-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-short-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-atomic-test-and-set-trueval+ 1)

(defparameter claylib/wrap::+%%gcc-atomic-wchar-t-lock-free+ 2)

(defparameter claylib/wrap::+%%gcc-have-dwarf2-cfi-asm+ 1)
...
(defparameter claylib/wrap::+%%glibc-flt-eval-method+ 2)
...
(defparameter claylib/wrap::+%%gnuc-minor--+ 2)

(defparameter claylib/wrap::+%%gnuc-patchlevel--+ 1)

(defparameter claylib/wrap::+%%gnuc-stdc-inline--+ nil)

(defparameter claylib/wrap::+%%gnuc-va-list+ 1)

(defparameter claylib/wrap::+%%gnuc--+ 4)

(defparameter claylib/wrap::+%%gnu-library--+ 6)

(defparameter claylib/wrap::+%%gxx-abi-version+ 1002)
...
(defparameter claylib/wrap::+%%intptr-fm-td--+ "ld")

(defparameter claylib/wrap::+%%intptr-fm-ti--+ "li")

(defparameter claylib/wrap::+%%intptr-max--+ 2147483647)

(defparameter claylib/wrap::+%%intptr-type--+ nil)

(defparameter claylib/wrap::+%%intptr-width--+ 32)
...
(defparameter claylib/wrap::+%%kernel-old-timeval-matches-timeval64+ 0)

(defparameter claylib/wrap::+%%kernel-strict-names+ nil)

(defparameter claylib/wrap::+%%key-t-type+ nil)

(defparameter claylib/wrap::+%%lahf-sahf--+ 1)

(defparameter claylib/wrap::+%%ldbl-decimal-dig--+ 21)

(defparameter claylib/wrap::+%%ldbl-denorm-min--+ 0.0D0)

(defparameter claylib/wrap::+%%ldbl-dig--+ 18)

(defparameter claylib/wrap::+%%ldbl-epsilon--+ 1.0842021724855044D-19)
...
(defparameter claylib/wrap::+%%ldbl-mant-dig--+ 64)

(defparameter claylib/wrap::+%%ldbl-max-10-exp--+ 4932)

(defparameter claylib/wrap::+%%ldbl-max-exp--+ 16384)

(defparameter claylib/wrap::+%%ldbl-max--+ :short-float-positive-infinity)

(defparameter claylib/wrap::+%%ldbl-min-10-exp--+ -4931)

(defparameter claylib/wrap::+%%ldbl-min-exp--+ -16381)

(defparameter claylib/wrap::+%%ldbl-min--+ 0.0D0)
...
(defparameter claylib/wrap::+%%mach--+ 1)
...
(defparameter claylib/wrap::+%%pointer-width--+ 32)

(defparameter claylib/wrap::+%%pragma-redefine-extname+ 1)

(defparameter claylib/wrap::+%%ptrdiff-fm-td--+ "d")

(defparameter claylib/wrap::+%%ptrdiff-fm-ti--+ "i")

(defparameter claylib/wrap::+%%ptrdiff-max--+ 2147483647)

(defparameter claylib/wrap::+%%ptrdiff-type--+ nil)

(defparameter claylib/wrap::+%%ptrdiff-width--+ 32)

(defparameter claylib/wrap::+%%register-prefix--+ nil)

(defparameter claylib/wrap::+%%rlim64-t-type+ nil)

(defparameter claylib/wrap::+%%rlim-t-matches-rlim64-t+ 0)
...
(defparameter claylib/wrap::+%%sizeof-long-double--+ 16)

(defparameter claylib/wrap::+%%sizeof-long-long--+ 8)

(defparameter claylib/wrap::+%%sizeof-long--+ 4)

(defparameter claylib/wrap::+%%sizeof-pointer--+ 4)

(defparameter claylib/wrap::+%%sizeof-ptrdiff-t--+ 4)

(defparameter claylib/wrap::+%%sizeof-short--+ 2)

(defparameter claylib/wrap::+%%sizeof-size-t--+ 4)

(defparameter claylib/wrap::+%%sizeof-wchar-t--+ 4)

(defparameter claylib/wrap::+%%sizeof-wint-t--+ 4)

(defparameter claylib/wrap::+%%size-fmtx--+ "lX")

(defparameter claylib/wrap::+%%size-fm-to--+ "lo")

(defparameter claylib/wrap::+%%size-fm-tu--+ "lu")

(defparameter claylib/wrap::+%%size-fm-tx--+ "lx")

(defparameter claylib/wrap::+%%size-max--+ 4294967295)

(defparameter claylib/wrap::+%%size-type--+ nil)

(defparameter claylib/wrap::+%%size-width--+ 32)
...
(defparameter claylib/wrap::+%%statfs-matches-statfs64+ 0)
...
(defparameter claylib/wrap::+%%stdc-no-threads--+ 1)
...
(defparameter claylib/wrap::+%%stdc--+ 1)
...
(defparameter claylib/wrap::+%%throw+ 1)

(defparameter claylib/wrap::+%%thrownl+ 1)

(defparameter claylib/wrap::+%%time64-t-type+ nil)

(defparameter claylib/wrap::+%%timer-t-type+ nil)

(defparameter claylib/wrap::+%%timesize+ 32)
...
(defparameter claylib/wrap::+%%uintptr-fmtx--+ "lX")

(defparameter claylib/wrap::+%%uintptr-fm-to--+ "lo")

(defparameter claylib/wrap::+%%uintptr-fm-tu--+ "lu")

(defparameter claylib/wrap::+%%uintptr-fm-tx--+ "lx")

(defparameter claylib/wrap::+%%uintptr-max--+ 4294967295)

(defparameter claylib/wrap::+%%uintptr-type--+ nil)

(defparameter claylib/wrap::+%%uintptr-width--+ 32)
...
(defparameter claylib/wrap::+%%use-atfile+ nil)

(defparameter claylib/wrap::+%%use-fortify-level+ 0)

(defparameter claylib/wrap::+%%use-isoc11+ 1)

(defparameter claylib/wrap::+%%use-isoc95+ nil)

(defparameter claylib/wrap::+%%use-isoc99+ 1)

(defparameter claylib/wrap::+%%use-misc+ nil)

(defparameter claylib/wrap::+%%use-posix+ nil)

(defparameter claylib/wrap::+%%use-posix199309+ nil)

(defparameter claylib/wrap::+%%use-posix199506+ nil)

(defparameter claylib/wrap::+%%use-posix2+ nil)

(defparameter claylib/wrap::+%%use-posix-implicitly+ nil)

(defparameter claylib/wrap::+%%use-xopen2k+ nil)

(defparameter claylib/wrap::+%%use-xopen2k8+ nil)
...
(defparameter claylib/wrap::+%%wchar-max--+ 2147483647)

(defparameter claylib/wrap::+%%wchar-type--+ nil)

(defparameter claylib/wrap::+%%wchar-width--+ 32)

(defparameter claylib/wrap::+%%wint-max--+ 2147483647)

(defparameter claylib/wrap::+%%wint-type--+ nil)

(defparameter claylib/wrap::+%%wint-width--+ 32)

(defparameter claylib/wrap::+%%wordsize+ 32)

(defparameter claylib/wrap::+%%wordsize32-ptrdiff-long+ 0)

(defparameter claylib/wrap::+%%wordsize32-size-ulong+ 0)

(defparameter claylib/wrap::+%%wordsize-time64-compat32+ 0)
...
(defparameter claylib/wrap::+%%block+ nil)

(defparameter claylib/wrap::+%%bool-true-false-are-defined+ nil)
...
(defparameter claylib/wrap::+%%clang-wide-literal-encoding--+ "UTF-32")
...
(defparameter claylib/wrap::+%%i386+ 1)

(defparameter claylib/wrap::+%%i386--+ 1)

(defparameter claylib/wrap::+%%i686+ 1)

(defparameter claylib/wrap::+%%i686--+ 1)

(defparameter claylib/wrap::+%%llvm--+ 1)

(defparameter claylib/wrap::+%%nonnull+ nil)

(defparameter claylib/wrap::+%%null-unspecified+ nil)

(defparameter claylib/wrap::+%%nullable+ nil)

(defparameter claylib/wrap::+%%pentiumpro+ 1)
...
(defparameter claylib/wrap::+%%strong+ nil)

(defparameter claylib/wrap::+%%stub-chflags+ nil)

(defparameter claylib/wrap::+%%stub-fchflags+ nil)

(defparameter claylib/wrap::+%%stub-gtty+ nil)

(defparameter claylib/wrap::+%%stub-revoke+ nil)

(defparameter claylib/wrap::+%%stub-setlogin+ nil)

(defparameter claylib/wrap::+%%stub-sigreturn+ nil)

(defparameter claylib/wrap::+%%stub-stty+ nil)

(defparameter claylib/wrap::+%%tune-i686--+ 1)

(defparameter claylib/wrap::+%%tune-pentiumpro--+ 1)

(defparameter claylib/wrap::+%%unsafe-unretained+ nil)

(defparameter claylib/wrap::+%%weak+ nil)
...
(cffi:defctype claylib/wrap::%%blkcnt64-t :long-long)
...
(cffi:defctype claylib/wrap::%%dev-t :unsigned-long-long)

(cffi:defctype claylib/wrap::%%fsblkcnt64-t :unsigned-long-long)

(cffi:defctype claylib/wrap::%%fsblkcnt-t :unsigned-long)

(cffi:defctype claylib/wrap::%%fsfilcnt64-t :unsigned-long-long)
...
(cffi:defctype claylib/wrap::%%fsword-t :int)

(cffi:defctype claylib/wrap::%%gid-t :unsigned-int)

(cffi:defctype claylib/wrap::%%id-t :unsigned-int)

(cffi:defctype claylib/wrap::%%ino64-t :unsigned-long-long)
...
(cffi:defctype claylib/wrap::%%int64-t :long-long)
...
(cffi:defctype claylib/wrap::%%int-least64-t :long-long)

(cffi:defctype claylib/wrap::%%int-least8-t :char)

(cffi:defctype claylib/wrap::%%intmax-t :long-long)

(cffi:defctype claylib/wrap::%%intptr-t :int)

(cffi:defctype claylib/wrap::%%key-t :int)

(cffi:defctype claylib/wrap::%%loff-t :long-long)

(cffi:defctype claylib/wrap::%%mode-t :unsigned-int)

(cffi:defctype claylib/wrap::%%nlink-t :unsigned-int)

(cffi:defctype claylib/wrap::%%off64-t :long-long)

(cffi:defctype claylib/wrap::%%off-t :long)

(cffi:defctype claylib/wrap::%%pid-t :int)

(cffi:defctype claylib/wrap::%%quad-t :long-long)

(cffi:defctype claylib/wrap::%%rlim64-t :unsigned-long-long)
...
(cffi:defctype claylib/wrap::%%ssize-t :int)

(cffi:defctype claylib/wrap::%%suseconds64-t :long-long)
...
(cffi:defctype claylib/wrap::%%time64-t :long-long)
...
(cffi:defctype claylib/wrap::%%u-quad-t :unsigned-long-long)
...
(cffi:defctype claylib/wrap::%%uint64-t :unsigned-long-long)
...
(cffi:defctype claylib/wrap::%%uint-least64-t :unsigned-long-long)

(cffi:defctype claylib/wrap::%%uint-least8-t :unsigned-char)

(cffi:defctype claylib/wrap::%%uintmax-t :unsigned-long-long)

(cffi:defctype claylib/wrap::%%useconds-t :unsigned-int)

(cffi:defctype claylib/wrap::double-t claylib/wrap::long-double)

(cffi:defctype claylib/wrap::float-t claylib/wrap::long-double)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-long-lock-free+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%strong+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%dynamic--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%null-unspecified+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-pointer-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gnuc-patchlevel--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-stty+ :claylib/wrap)
  ...
  (export 'claylib/wrap::nanf :claylib/wrap)
  (export 'claylib/wrap::+%%stdc-no-threads--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%tune-i686--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%lahf-sahf--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-test-and-set-trueval+
          :claylib/wrap)
  (export 'claylib/wrap::+%%gnuc--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%nullable+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%wordsize32-size-ulong+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gxx-abi-version+ :claylib/wrap)
  (export 'claylib/wrap::lroundf :claylib/wrap)
  (export 'claylib/wrap::%%y0f :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-revoke+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%pentiumpro+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-char16-t-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-bool-lock-free+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%environment-mac-os-x-version-min-required--+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gnuc-minor--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-char32-t-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-chflags+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-short-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-llong-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-sigreturn+ :claylib/wrap)
  (export 'claylib/wrap::get-working-directory :claylib/wrap)
  (export 'claylib/wrap::+%%decl-simd-tanhf128+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-int-lock-free+ :claylib/wrap)
  (export 'claylib/wrap::nearbyint :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%wordsize32-ptrdiff-long+ :claylib/wrap)
  (export 'claylib/wrap::+%%decl-simd-tanf128+ :claylib/wrap)
  (export 'claylib/wrap::+mouse-middle-button+ :claylib/wrap)
  (export 'claylib/wrap::+%%gnuc-stdc-inline--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%blocks--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%mach--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%opencl-memory-scope-device+
          :claylib/wrap)
  (export 'claylib/wrap::+%%i686--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stdc--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-wchar-t-lock-free+
          :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%tune-pentiumpro--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%nonnull+ :claylib/wrap)
  (export 'claylib/wrap::%%ceil :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%unsafe-unretained+ :claylib/wrap)
  ...
  (export 'claylib/wrap::%%time64-t :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%apple--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-atomic-char-lock-free+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%block+ :claylib/wrap)
  ...
  (export 'claylib/wrap::%%cbrtf :claylib/wrap)
  (export 'claylib/wrap::+%%weak+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-gtty+ :claylib/wrap)
  (export 'claylib/wrap::llrintl :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%gcc-have-dwarf2-cfi-asm+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%apple-cc--+ :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-setlogin+ :claylib/wrap)
  (export 'claylib/wrap::%%lround :claylib/wrap)
  ...
  (export 'claylib/wrap::+%%stub-fchflags+ :claylib/wrap)
